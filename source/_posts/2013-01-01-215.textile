...
<div></div>
<div>    在追内核代码的过程中，发现func_a()这个函数其实是初始化部分的函数。函数定义如下：</div>
<div style="padding-left: 30px;">int __init func_a()</div>
<div style="padding-left: 30px;">{</div>
<div style="padding-left: 30px;">     ...</div>
<div style="padding-left: 30px;">}</div>
<div></div>
<div>    __init这个宏的定义如下：</div>
<div><a href="http://www.laoar.net/wp-content/uploads/2013/01/2dc250f6dd2ab58b5b03df658953ef501.png"><img class="aligncenter size-full wp-image-217" title="2dc250f6dd2ab58b5b03df658953ef50" src="http://www.laoar.net/wp-content/uploads/2013/01/2dc250f6dd2ab58b5b03df658953ef501.png" alt="" width="754" height="111" /></a>    它的作用是，将这个函数放到.init.text这个section中。section是elf格式的一个概念，具体可google之。 os是怎么处理.init.text这个section的哪？</div>
<div></div>
<div>    在free_initmem()这个函数里面会将这个section所占用的内存给释放掉：</div>
<div><a href="http://www.laoar.net/wp-content/uploads/2013/01/c07559b7c01affcc71884aed64c6f0712.png"><img class="aligncenter size-full wp-image-221" title="c07559b7c01affcc71884aed64c6f071" src="http://www.laoar.net/wp-content/uploads/2013/01/c07559b7c01affcc71884aed64c6f0712.png" alt="" width="825" height="378" /></a>注释：</div>
